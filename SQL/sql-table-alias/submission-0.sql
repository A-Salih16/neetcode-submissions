...
select us.name,us.email,er.company_name,er.job_title from users as us inner join employment_records as er on us.id=er.user_id       order by er.company_name ;
